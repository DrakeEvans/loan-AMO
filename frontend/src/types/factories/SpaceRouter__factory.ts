...
import type { SpaceRouter, SpaceRouterInterface } from "../SpaceRouter";
...
export class SpaceRouter__factory {
  static readonly abi = _abi;
  static createInterface(): SpaceRouterInterface {
    return new utils.Interface(_abi) as SpaceRouterInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): SpaceRouter {
